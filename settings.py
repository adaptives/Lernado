...
SECRET_KEY = '$a3i4-oqb5e@dcgoe4bvpn=$!1aswbb#&fa=iuyf@s_lrftl5#'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'lernado.custom_context_processors.sidebar_widgets',
)
...
TEMPLATE_DIRS = (
    ...
    os.path.join(os.path.dirname(__file__), 'accounts/templates').replace('\\','/'),
)
